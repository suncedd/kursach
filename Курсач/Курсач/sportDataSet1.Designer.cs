...
namespace Курсач.sportDataSet1TableAdapters {
...
SELECT КодСотрудника, ФИО, КодДолжность, Статус FROM Сотрудники WHERE (КодСотрудника = @КодСотрудника)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Курсач.Properties.Settings.Default.sportConnectionString;
        }
        ...
        public virtual int Fill(sportDataSet1.СотрудникиDataTable dataTable) {
        ...
        public virtual sportDataSet1.СотрудникиDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            sportDataSet1.СотрудникиDataTable dataTable = new sportDataSet1.СотрудникиDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(sportDataSet1.СотрудникиDataTable dataTable) {
